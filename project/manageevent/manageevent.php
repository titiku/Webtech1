  ...
  <?php foreach($people as $person): ?>
    ...
    <tr>
      ...
      <td>
        ...
        <button class="btn btn-info" style="margin-bottom:20%;width:100%;" onclick="ball('<?= $person->get_id_ev() ?>','<?= $person->get_id_ac() ?>','<?= $person->get_name_event() ?>
  ...
  <div class="modal-content" >
    ...
    <div class="modal-body">
            ...
            <form id="formupdate" action="update.php" method="post" enctype="multipart/form-data" >
              <input hidden id="id_ev" type="text" name="id_ev" value="">
                ...
                <input hidden id="current" type="text" name="current" value="">
                  ...
                  <input hidden id="create_time" type="text" name="create_time" value="">
                  <input hidden id="status" type="text" name="status" value="">
          ...
          <input  id="price" required value="" onkeypress="return event.keyCode != 13;" type="number"  name="free"  min="0" size="40px" style="margin-top:10px ; "  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" >
            ...
            <div class="input-group input-group-sm mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-sm" style="color:343A40 ; margin-top:10px ; font-size:18px ;background-color: #00cc99;">precondition</span>
          </div>
          <input   id="precondition" type="text" name="precondition" value="" style="margin-top:10px ; "  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" >
          </div>

          <div class="input-group input-group-sm mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text" id="inputGroup-sizing-sm" style="color:343A40 ; margin-top:10px ; font-size:18px ;background-color: #00cc99;">google form url</span>
        </div>
...
function ball(id_ev,id_ac,name_event,image,teaser_VDO,date,time,location,capacity,free,type,current,precondition,create_time,status,google_form_url) {
    ...
    document.getElementById("id_ev").value=id_ev.trim();
